package com.bank.bian.documentmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Document Maintenance Agreement".
 *
 ...
 * to its asset type (Document). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Document Maintenance Agreement";
